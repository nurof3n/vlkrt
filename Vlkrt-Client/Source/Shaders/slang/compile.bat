...
:: ================================================================== ::
:: compile.bat — compile all Slang ray-tracing shaders to SPIR-V
:: Output goes one directory up (../), where Renderer.cpp loads them.
:: Requires: slangc in PATH
:: ================================================================== ::

set OUT=..
:: Single search path covering all .slang modules
